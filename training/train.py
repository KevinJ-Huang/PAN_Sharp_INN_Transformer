...
sys.path.append("/home/jieh/Projects/PAN_Sharp/GPPNN/")
...
data_dir_ms_train = '/home/jieh/Projects/PAN_Sharp/yaogan/WV3_data/train128/ms/'
data_dir_pan_train = '/home/jieh/Projects/PAN_Sharp/yaogan/WV3_data/train128/pan/'
...
data_dir_ms_test = '/home/jieh/Projects/PAN_Sharp/yaogan/WV3_data/test128/ms/'
data_dir_pan_test = '/home/jieh/Projects/PAN_Sharp/yaogan/WV3_data/test128/pan/'
...
save_path = os.path.join(
    '/home/jieh/Projects/PAN_Sharp/GPPNN/training/logs/%s' % (model_str),
...
with torch.no_grad():
    ...
    for i, (ms, pan, gt) in enumerate(testloader):
        ...
        # imageio.imwrite(os.path.join(save_path, str(i)+'.tiff'),imgf.squeeze().detach().cpu().numpy().transpose(1,2,0))
